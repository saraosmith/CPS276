...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'saosmith';//this will be your WCC username
      $dbUsr = 'saosmith';//this will be your WCC username
      $dbPass = 'KHSZahgH4Yu2';//this will be the password found in the video.
